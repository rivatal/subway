...
for line in traindata:
	...
	fromstation.append(traintravel[8])
	tostation.append(traintravel[10])
...
#Riva: changed add_cycle to add_path
...
paths = nx.shortest_path(G, 's1013','s301') #?
print paths
plt.show()
