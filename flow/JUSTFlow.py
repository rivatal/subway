...
openingfile = open("station_ids_trips.csv")
...
for line in traindata:
	...
	trains.append(traintravel[1].strip())
	stations.append(traintravel[9].strip("\""))
	traveltime.append(float(traintravel[8].strip()))
...
for line in noondata:
	...
	G.node[stationid]["station"]=station
